...
Handles state transitions and approval record creation.
"""
from app import db
...
def transition_status(event, decision_str, user, comments=None):
    ...
    Validates permissions and updates event status.
    """
    ...
    # Enforce comments for Reject/Changes
